      ...
      <div className="px-6 py-12 md:px-12 lg:px-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mx-auto max-w-5xl grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      <Label htmlFor="box-style" className="text-lg font-semibold text-charcoal" style={{ fontFamily: 'var(--font-fraunces)' }}>Box Style</Label>
                  ...
                  {boxStyle === 'mystery' && (
                    <div className="space-y-6 pt-6 border-t border-stone">
                      <div className="space-y-2">
                        <Label htmlFor="box-title" className="text-charcoal">Box Title *</Label>
                        <Input
                          id="box-title"
                          value={boxTitle}
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="hint1" className="text-charcoal">Hint #1 *</Label>
                        <Input
                          id="hint1"
                          value={boxHint1}
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="hint2" className="text-charcoal">Hint #2 *</Label>
                        <Input
                          id="hint2"
                          value={boxHint2}
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="hidden-message" className="text-charcoal">Hidden Message (Optional)</Label>
                        <Textarea
                          id="hidden-message"
                          ...
                          className="min-h-[100px] border-b-2 border-stone"
                          maxLength={200}
                        />
                        <p className="text-xs text-charcoal/50">
            ...
            {/* Right side - Polaroid Preview */}
            <div className="space-y-6">
              <Card className="p-8 shadow-lg bg-sage/5">
                <h3 className="text-lg font-semibold mb-6 text-charcoal" style={{ fontFamily: 'var(--font-fraunces)' }}>Preview</h3>

                {/* Polaroid frame wrapper */}
                <div className="flex items-center justify-center p-4">
                  <div className="bg-white p-4 pb-12 shadow-2xl rotate-1 max-w-md w-full">
                    <div className="relative aspect-square rounded-lg overflow-hidden">
                      {boxStyle === 'standard' && photoData ? (
                        ...
                        <div className="relative w-full h-full bg-gradient-to-br from-amber-700 to-amber-900 flex items-center justify-center p-6">
                          {/* Wood texture effect */}
                          ...
                          <div className="relative text-center space-y-4 w-full">
                            {boxTitle && (
                              <p className="text-amber-100 text-xl md:text-2xl italic leading-relaxed"
                                style={{
                            ...
                            {boxHint1 && (
                              <p className="text-amber-200/90 text-base md:text-lg italic leading-relaxed"
                                style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.5)', fontFamily: 'var(--font-fraunces)' }}>
                                {boxHint1}
                              </p>
                            )}
                            {boxHint2 && (
